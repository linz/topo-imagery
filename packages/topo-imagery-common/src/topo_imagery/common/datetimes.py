...
def format_rfc_3339_datetime_string(datetime_object: datetime) -> str:
    ...
    ...
    common.datetimes.NaiveDatetimeError: Can't convert naive datetime, timezone aware datetime object needed
    """
...
def convert_utc_to_nz_datetime(datetime_object: datetime) -> datetime:
    ...
    Traceback (most recent call last):
    ...
    common.datetimes.NotUTCError: Input datetime must be in UTC
    """
    if datetime_object.tzinfo is None:
        raise NaiveDatetimeError()
