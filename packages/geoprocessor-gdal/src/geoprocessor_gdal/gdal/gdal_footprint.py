...
from geoprocessor_common.files.files_helper import SUFFIX_FOOTPRINT, get_file_name_from_path
from geoprocessor_gdal.gdal.gdal_commands import get_footprint_command
from geoprocessor_gdal.gdal.gdal_helper import run_gdal
