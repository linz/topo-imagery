...
from topo_imagery.common.datetimes import format_rfc_3339_datetime_string
from topo_imagery.gdal.gdal.gdalinfo import GdalInfo
from topo_imagery.stac.imagery.collection import ImageryCollection
from topo_imagery.stac.imagery.collection_context import CollectionContext
from topo_imagery.stac.imagery.create_stac import (
    create_collection,
    create_item,
    get_items_to_replace,
    merge_item_list_for_resupply,
)
from topo_imagery.stac.testing.generators import any_multihash_as_hex
from topo_imagery.stac.testing.helpers import any_epoch_datetime, any_epoch_datetime_string
...
def test_create_collection(fake_collection_context: CollectionContext, subtests: SubTests) -> None:
    current_datetime = any_epoch_datetime_string()
...
def test_merge_item_list_for_resupply(fake_collection_context: CollectionContext, subtests: SubTests) -> None:
    published_items = [
