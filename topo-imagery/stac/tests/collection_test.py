...
from topo-imagery.files.fs import read
from topo-imagery.stac.imagery.collection import ImageryCollection
from topo-imagery.stac.imagery.item import ImageryItem
...
def test_add_item(mocker, setup_collection: ImageryCollection) -> None:  # type: ignore
    ...
    mocker.patch("topo-imagery.stac.util.checksum.multihash_as_hex", return_value=checksum)
