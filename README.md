...
```bash
docker run -v ${HOME}/.aws/credentials:/root/.aws/credentials:ro -e AWS_PROFILE='your-aws-profile' 'image-id'  python create_extents.py --source 's3://path-to-the-tiff/image.tif'
```
