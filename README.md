...
This script takes a file path to a json file (manually created or generated by [the Argo Tasks tileindex-validate command](https://github.com/linz/argo-tasks/blob/master/README.md#tileindex-validate)) containing a list of tile names and the source files for each tile.
...
File paths can be local or s3 paths.

Example source file `file-list.json`:
