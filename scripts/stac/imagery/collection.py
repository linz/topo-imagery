...
from scripts.datetimes import convert_utc_to_nz, format_rfc_3339_datetime_string, parse_rfc_3339_datetime
...
class ImageryCollection:
    ...
    def set_title(self) -> None:
        ...
        # format date
        start_year = convert_utc_to_nz(parse_rfc_3339_datetime(temporal_extent[0][0])).year
        end_year = convert_utc_to_nz(parse_rfc_3339_datetime(temporal_extent[0][1])).year
