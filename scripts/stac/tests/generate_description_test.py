...
def test_generate_description_imagery() -> None:
    ...
    generated_description = generate_description(
        category="Rural Aerial Photos", region="auckland", start_date=datetime(2023, 1, 1), end_date=datetime(2023, 2, 2)
    )
...
def test_generate_description_elevation() -> None:
    ...
    generated_description = generate_description(
        category="DEM", region="auckland", start_date=datetime(2023, 1, 1), end_date=datetime(2023, 2, 2)
    )
    assert generated_description == description
...
def test_generate_description_elevation_location_input() -> None:
    ...
    generated_description = generate_description(
        category="DEM", region="auckland", start_date=datetime(2023, 1, 1), end_date=datetime(2023, 2, 2), location="Central"
    )
    assert generated_description == description
...
def test_generate_description_satellite_imagery() -> None:
    ...
    generated_description = generate_description(
        category="Satellite Imagery", region="auckland", start_date=datetime(2023, 1, 1), end_date=datetime(2023, 2, 2)
    )
    assert generated_description == description
