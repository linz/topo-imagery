...
def test_imagery_stac_item() -> None:
    ...
    assert item.stac["geometry"]["coordinates"] == [
        [[1799667.5, 5815977.0], [1800422.5, 5815977.0], [1800422.5, 5814986.0], [1799667.5, 5814986.0]]
    ]
    assert item.stac["bbox"] == [1799667.5, 5815977.0, 1800422.5, 5814986.0]
    assert (
        item.stac["assets"]["image"]["checksum:multihash"]
        == "1220cdef68d62fb912110b810e62edc53de07f7a44fb2b310db700e9d9dd58baa6b4"
    )
