...
class Relation(str, Enum):
    ...
    """ TODO: Explain where `derived_from` comes from. It is not in https://www.iana.org/assignments/link-relations/link-relations.xhtml nor in the stac-spec"""
...
class Link:
    ...
    Attributes:
        ...
        file_content: The content of the file that will be used to store the checksum in `file:checksum`. It assumes using the STAC `file` extension.
    """
    stac: dict[str, str]
